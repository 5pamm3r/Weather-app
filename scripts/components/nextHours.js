...
export const nextHours = async (city, country) => {
  try {
    ...
    nextHoursContainer('../../public/img/icons/rain-v.png','13','4')
    nextHoursContainer('../../public/img/icons/rain-v.png','15','4')
    nextHoursContainer('../../public/img/icons/rain-v.png','23','4')
    nextHoursContainer('../../public/img/icons/rain-v.png','19','4')
